...
<p>
  ...
  But <code>parser.js</code> does not current support this feature.
...
J. Johnson //et al.// (1989). "The Xerox Star: a
   ...
   pp. 11-26, Sept. 1989, doi: 10.1109/2.35211.</pre>
...
holes after the next event loop."</pre>
  ...
  <li>
    ...
    <p>
      ...
      But sometimes sentences end with single quotes, double quotes, parentheses, square braces, a question mark or an exclaimation point.
